...
class BDD {
    ...
    */
    function __construct() {
        ...
        $this->typeBDD=$_ENV['TYPEBDD'];
        $this->host=$_ENV['HOST'];
        $this->dbname=$_ENV['BDDNAME'];
