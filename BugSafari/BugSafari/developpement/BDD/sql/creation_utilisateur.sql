...
CREATE USER 'sauvegarde'@'localhost' IDENTIFIED BY 'pwd';
-- admin
GRANT ALL PRIVILEGES ON BugSafari_DEV.* TO 'johan'@'localhost';
GRANT ALL PRIVILEGES ON BugSafari_PROD.* TO 'johan'@'localhost';
GRANT ALL PRIVILEGES ON BugSafari_TEST.* TO 'johan'@'localhost';
GRANT ALL PRIVILEGES ON BugSafari_DEV.* TO 'maxime'@'localhost';
GRANT ALL PRIVILEGES ON BugSafari_PROD.* TO 'maxime'@'localhost';
GRANT ALL PRIVILEGES ON BugSafari_TEST.* TO 'maxime'@'localhost';
GRANT SELECT, LOCK TABLES, SHOW VIEW ON BugSafari_TEST.* TO 'sauvegarde'@'localhost';
GRANT SELECT, LOCK TABLES, SHOW VIEW ON BugSafari_DEV.* TO 'sauvegarde'@'localhost';
GRANT SELECT, LOCK TABLES, SHOW VIEW ON BugSafari_PROD.* TO 'sauvegarde'@'localhost';
