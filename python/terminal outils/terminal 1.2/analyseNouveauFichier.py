            ...
            for chemin ,dossier, fichier in os.walk(cheminNAS[i]):
                ...
                for j in dossier:
                    ...
                    if j in listeDossierFichier:
                        ...
                        NouveauDossier.append(chemin+"\\"+j)
                ...
                for j in fichier:
                    ...
                    #si il est déja enregistré affiché OUI
                    if j in listeDossierFichier: 
                        console.print("[yellow]fichier [/yellow][white]{}[/white] [chartreuse3]OUI[/chartreuse3]".format(j))
                        #sinon afficher NON
                    else:
                        console.print("[yellow]fichier [/yellow][white]{}[/white] [red3]NON[/red3]".format(j))
                        NouveauFichier.append(chemin+"\\"+j)
