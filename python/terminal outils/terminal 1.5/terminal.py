...
from analyseModificationFichier import *
from analyseNouveauFichier import *
from scanPort import *
from demandeHeure import *
import os
...
\
    ...
    console.print("\n[deep_sky_blue2]\
\
        [1] - analyse modification fichier\n\
        [2] - recherche nouveau fichier et dossier\n\
        [3] - scanne port\n\
        [4] - demande\n\
        [5] - [/deep_sky_blue2][light_coral]quitter\
\
        [/light_coral]")
...
[/deep_sky_blue2]")
    ...
    if option == "1":
        analyseModificationFichier()
    #option 2: recherche nouveau fichier et dossier
    elif option == "2":
        nouveauFichier()
    #option 3: scanne port
    elif option == "3":
        analysePort()
    #option 4: quitté
    elif option == "4":
